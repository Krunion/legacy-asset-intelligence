  ...
  list: protectedProcedure
    .input(
      z.object({
        ...
        status: z.enum(["active", "inactive", "disposed", "in_repair", "lost", "transferred"]).optional(),
  ...
  create: protectedProcedure
    .input(
      z.object({
        ...
        categoryId: z.number().optional(),
        status: z.enum(["active", "inactive", "disposed", "in_repair", "lost", "transferred"]).default("active"),
        ...
        barcodeType: z.enum(["code128", "code39", "qr"]).default("code128"),
  ...
  update: protectedProcedure
    .input(
      z.object({
        ...
        barcodeType: z.enum(["code128", "code39", "qr"]).optional(),
