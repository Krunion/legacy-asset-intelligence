        ...
        {activeTab === "client" && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "2rem" }}>
              ...
              <div><label style={labelStyle}>Estimated Asset Count</label><input style={inputStyle} type="number" value={assetCount} onChange={e => setAssetCount(Number(e.target.value))} min={1} /></div>
              <div><label style={labelStyle}>Number of Locations</label><input style={inputStyle} type="number" value={locations} onChange={e => setLocations(Number(e.target.value))} min={1} /></div>
              ...
              <div><label style={labelStyle}>Estimated Recoverable Capital ($)</label><input style={inputStyle} type="number" value={recoverableCapital} onChange={e => setRecoverableCapital(Number(e.target.value))} min={0} /></div>
              ...
              <div><label style={labelStyle}>Timeframe (weeks)</label><input style={inputStyle} type="number" value={timeframe} onChange={e => setTimeframe(Number(e.target.value))} min={1} /></div>
        ...
        {activeTab === "assumptions" && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1rem", marginBottom: "2rem" }}>
              <div><label style={labelStyle}>Row 40: Field Productivity (assets/person/day)</label><input style={inputStyle} type="number" value={fieldProductivity} onChange={e => setFieldProductivity(Number(e.target.value))} min={1} /></div>
              <div><label style={labelStyle}>Row 41: Field Contractor Pay ($/hr)</label><input style={inputStyle} type="number" value={fieldContractorPay} onChange={e => setFieldContractorPay(Number(e.target.value))} min={0} /></div>
              <div><label style={labelStyle}>Row 42: Reconciliation Pay ($/hr)</label><input style={inputStyle} type="number" value={reconciliationPay} onChange={e => setReconciliationPay(Number(e.target.value))} min={0} /></div>
              <div><label style={labelStyle}>Row 43: QA Pay ($/hr)</label><input style={inputStyle} type="number" value={qaPay} onChange={e => setQaPay(Number(e.target.value))} min={0} /></div>
              <div><label style={labelStyle}>Row 44: PM Pay ($/hr)</label><input style={inputStyle} type="number" value={pmPay} onChange={e => setPmPay(Number(e.target.value))} min={0} /></div>
              <div><label style={labelStyle}>Row 45: Workday Hours (hrs/day)</label><input style={inputStyle} type="number" value={workdayHours} onChange={e => setWorkdayHours(Number(e.target.value))} min={1} /></div>
              <div><label style={labelStyle}>Row 46: Reconciliation % of Field Hrs</label><input style={inputStyle} type="number" step="0.01" value={reconciliationPct} onChange={e => setReconciliationPct(Number(e.target.value))} min={0} max={1} /><span style={{ fontSize: "0.7rem", color: C.muted }}>0.30 = 30%</span></div>
              <div><label style={labelStyle}>Row 47: QA % of Field Hrs</label><input style={inputStyle} type="number" step="0.01" value={qaPct} onChange={e => setQaPct(Number(e.target.value))} min={0} max={1} /><span style={{ fontSize: "0.7rem", color: C.muted }}>0.08 = 8%</span></div>
              <div><label style={labelStyle}>Row 48: PM % of Field Hrs</label><input style={inputStyle} type="number" step="0.01" value={pmPct} onChange={e => setPmPct(Number(e.target.value))} min={0} max={1} /><span style={{ fontSize: "0.7rem", color: C.muted }}>0.06 = 6%</span></div>
              <div><label style={labelStyle}>Row 49: Traveling LAI Leaders</label><input style={inputStyle} type="number" value={travelingLeaders} onChange={e => setTravelingLeaders(Number(e.target.value))} min={0} /></div>
              <div><label style={labelStyle}>Row 50: Average Project Weeks</label><input style={inputStyle} type="number" value={avgProjectWeeks} onChange={e => setAvgProjectWeeks(Number(e.target.value))} min={1} /></div>
              <div><label style={labelStyle}>Row 51: Weekly Lodging/Traveler ($/wk)</label><input style={inputStyle} type="number" value={weeklyLodging} onChange={e => setWeeklyLodging(Number(e.target.value))} min={0} /><span style={{ fontSize: "0.7rem", color: C.muted }}>$150/night × 7</span></div>
              <div><label style={labelStyle}>Row 52: Weekly Per Diem/Traveler ($/wk)</label><input style={inputStyle} type="number" value={weeklyPerDiem} onChange={e => setWeeklyPerDiem(Number(e.target.value))} min={0} /><span style={{ fontSize: "0.7rem", color: C.muted }}>$70/day × 7</span></div>
              <div><label style={labelStyle}>Row 53: Weekly Transport/Traveler ($/wk)</label><input style={inputStyle} type="number" value={weeklyTransport} onChange={e => setWeeklyTransport(Number(e.target.value))} min={0} /><span style={{ fontSize: "0.7rem", color: C.muted }}>Flights/rental/mileage</span></div>
              <div><label style={labelStyle}>Row 54: Overhead Allocation (% of revenue)</label><input style={inputStyle} type="number" step="0.01" value={overheadAllocation} onChange={e => setOverheadAllocation(Number(e.target.value))} min={0} max={1} /><span style={{ fontSize: "0.7rem", color: C.muted }}>0.15 = 15%</span></div>
              <div><label style={labelStyle}>Row 58: Annual Ongoing Savings (%)</label><input style={inputStyle} type="number" step="0.01" value={annualOngoingSavings} onChange={e => setAnnualOngoingSavings(Number(e.target.value))} min={0} max={1} /><span style={{ fontSize: "0.7rem", color: C.muted }}>0.10 = 10% (for 3-yr ROI)</span></div>
            </div>
          </div>
        )}
