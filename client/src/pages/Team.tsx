...
const team: TeamMember[] = [
  {
    ...
    bio: [
      ...
      "Kevin holds a Bachelor of Science in Psychology and a Master of Science in Organizational Leadership and Applied Business Management, which he completed with a 4.0 GPA, earning him the Distinguished Scholar title. He is currently pursuing a Doctor of Business Administration to further advance his expertise in executive leadership, organizational strategy, operational performance, and sustainable business growth.",
  ...
  },
  {
    ...
    bio: [
      "Darryl Fedric serves as Chief Strategy Officer of Legacy Asset Intelligence, where he helps lead corporate strategy, market intelligence, competitive analysis, strategic planning, innovation initiatives, corporate partnerships, and long-term organizational growth. Working alongside LAI's executive leadership, he helps evaluate market opportunities, establish strategic priorities, strengthen the company's competitive position, and translate long-term objectives into focused, actionable initiatives.",
      "Darryl brings a private-investigator background that strengthens his analytical, evidence-based approach to strategy and executive decision-making. His experience includes disciplined observation, interviewing, documentation, evidence handling, issue follow-up, and professional interaction in sensitive situations. This background enables him to examine complex circumstances carefully, distinguish assumptions from verified facts, recognize emerging risks and opportunities, and provide leadership with well-supported strategic insight.",
      "His leadership approach is grounded in investigative thinking, client advocacy, issue resolution, confidentiality, fairness, neutrality, and close attention to facts and evidence. Darryl also brings an important client and stakeholder perspective to corporate planning, helping LAI connect market needs and relationship intelligence with decisions involving services, technology, partnerships, organizational capabilities, and future expansion. His commitment to evidence preservation, communication quality, professional field conduct, and thorough follow-through further supports LAI's credibility and strategic relationships.",
      "As Chief Strategy Officer, Darryl helps ensure that major initiatives remain aligned with LAI's mission to recover hidden and lost capital, eliminate waste, improve asset visibility, and create stronger asset governance. His combination of investigative discipline, strategic analysis, relationship awareness, and long-term thinking supports LAI's continued development as a trusted asset intelligence and capital-recovery partner.",
    ],
  },
  {
    name: "Andrea Haynes",
