...
const insights = [
  ...
  { category: "Case Insight", title: "How a $2B Manufacturer Recovered $4.2M in Ghost Assets", excerpt: "A detailed examination of how a mid-market manufacturer discovered that 22% of their fixed asset register consisted of ghost assets, and the systematic approach used to recover capital.", readTime: "8 min read", slug: "2025-state-enterprise-asset-management" },
  ...
  { category: "Whitepaper", title: "The $264 Billion Opportunity: Fixed Asset Management Market Dynamics", excerpt: "An in-depth analysis of the global fixed asset management market, growth drivers, competitive landscape, and where organizations should invest for maximum capital recovery.", readTime: "14 min read", slug: "fixed-asset-management-market-dynamics" },
