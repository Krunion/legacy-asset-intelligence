...
const insights = [
  ...
  { category: "Industry Analysis", title: "Fixed Asset Management in Healthcare: Regulatory Compliance and Capital Recovery", excerpt: "Healthcare systems face unique challenges in asset accountability due to regulatory requirements, rapid technology turnover, and distributed facility networks. Learn how leading systems are recovering capital.", readTime: "9 min read" },
  { category: "Whitepaper", title: "From Spreadsheets to Smart Governance: The Asset Maturity Journey", excerpt: "A five-level maturity framework for evaluating your organization's asset management sophistication, with practical steps to advance from reactive tracking to proactive governance.", readTime: "15 min read" },
  { category: "Case Insight", title: "How a $2B Manufacturer Recovered $4.2M in Ghost Assets", excerpt: "A detailed examination of how a mid-market manufacturer discovered that 22% of their fixed asset register consisted of ghost assets, and the systematic approach used to recover capital.", readTime: "8 min read" },
  { category: "Technology Brief", title: "RFID, IoT, and the Future of Asset Verification", excerpt: "Emerging technologies are transforming how organizations track and verify physical assets. This brief examines the ROI of technology-enabled asset management versus traditional manual approaches.", readTime: "10 min read" },
  { category: "Executive Guide", title: "Building a Business Case for Asset Intelligence Investment", excerpt: "A step-by-step framework for building an internal business case that quantifies the ROI of professional asset verification and governance implementation.", readTime: "11 min read" },
  { category: "Industry Analysis", title: "Government & Education: Compliance-Driven Asset Accountability", excerpt: "Public sector organizations face GASB compliance requirements that demand accurate asset records. This analysis explores how agencies are meeting compliance while recovering hidden capital.", readTime: "9 min read" },
  { category: "Whitepaper", title: "The $264 Billion Opportunity: Fixed Asset Management Market Dynamics", excerpt: "An in-depth analysis of the global fixed asset management market, growth drivers, competitive landscape, and where organizations should invest for maximum capital recovery.", readTime: "14 min read" },
  ...
  { category: "Industry Analysis", title: "Construction & Heavy Equipment: Mobile Asset Challenges", excerpt: "Construction companies face unique challenges tracking equipment across job sites. This analysis examines how leading firms are implementing governance frameworks for mobile asset accountability.", readTime: "8 min read" },
  { category: "Strategic Brief", title: "The Relationship Between Asset Intelligence and ESG Reporting", excerpt: "Accurate asset data supports environmental, social, and governance reporting requirements. This brief explores the intersection of asset accountability and sustainability commitments.", readTime: "6 min read" },
  { category: "Executive Guide", title: "Preparing Your Organization for an Asset Intelligence Assessment", excerpt: "What leadership should know before engaging in an Executive Asset Intelligence Assessment — preparation steps, stakeholder involvement, and how to maximize value from the process.", readTime: "8 min read" },
];
...
export default function Insights() {
  ...
  const categories = ["All", "Executive Guide", "Industry Analysis", "Whitepaper", "Case Insight", "Technology Brief", "Executive Perspective", "Strategic Brief"];
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "0 2rem 3rem" }}>
          <div style={{ background: C.glass, backdropFilter: "blur(12px)", border: `1px solid ${C.glassBorder}`, borderRadius: 10, padding: "2.5rem", borderLeft: `3px solid ${C.gold}` }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
              ...
              <button onClick={() => navigate("/contact")} style={{ background: "transparent", border: `1px solid ${C.goldBorder}`, color: C.gold, padding: "0.4rem 1rem", borderRadius: 4, fontFamily: "'Source Sans 3', sans-serif", fontSize: "0.78rem", fontWeight: 600, cursor: "pointer" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 2rem 4rem" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "1.25rem" }}>
            {filtered.slice(1).map((insight, i) => (
              <div key={i} style={{ background: C.glass, backdropFilter: "blur(8px)", border: `1px solid ${C.glassBorder}`, borderRadius: 8, padding: "1.75rem", display: "flex", flexDirection: "column", transition: "border-color 0.3s" }}>
